...
import 'package:agri/widgets/inputwidgets.dart';
      ...
      children: <Widget>[
        ...
        Column(
          children: <Widget>[
            ...
            roundedRectButton("Let's get Started as Investor",signInGradients, false
            ),
            roundedRectButton("Let's get Started as Farmer", signUpGradients, false),
          ],
        )
      ],
    );
